 ...
 *
 * @param lhs the left-hand-side of the comparison, `lhs` is not mutated
 *
 * @param rhs the right-hand-side of the comparison, `rhs` is not mutated
 *
 ...
 *
 * @param t0 the initial time to add to, `t0` is not mutated
 *
